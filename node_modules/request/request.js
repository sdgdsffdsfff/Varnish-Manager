...
Request.prototype.init = function (options) {
  ...
  self.setHost = false
  debug("self.hasHeader('host')",self.hasHeader('host'));
...
Request.prototype.onRequestResponse = function (response) {
  ...
  debug('======self.setHost',self.setHost);
  ...
  if (redirectTo && self.allowRedirect.call(self, response)) {
    ...
    if(self.uri.host==='www.newegg3.com.sh'){
        self.uri.href=self.uri.href.replace('www.newegg3.com.sh',uriPrev.host);
        self.uri.host = uriPrev.host;
        self.uri.hostname = uriPrev.hostname;
        //self.setHeader('host','www.newegg3.com.sh');
    }
